...
setwd("/Users/laurasaba/Documents/BxD/eQTL/QTLReaper Files")
...
write.table(chrid,file="/Users/laurasaba/Documents/BxD/eQTL/Rqtl Files/chrid.dat",sep="\t",row.names=FALSE,col.names=FALSE, quote = FALSE)
write.table(markerpos,file="/Users/laurasaba/Documents/BxD/eQTL/Rqtl Files/markerpos.txt",sep="\t",row.names=FALSE,col.names=FALSE, quote = FALSE)
write.table(mnames,file="/Users/laurasaba/Documents/BxD/eQTL/Rqtl Files/mnames.txt",sep="\t",row.names=FALSE,col.names=FALSE, quote = FALSE)
write.table(geno,file="/Users/laurasaba/Documents/BxD/eQTL/Rqtl Files/geno.dat",sep="\t",row.names=FALSE,col.names=FALSE, quote = FALSE)
write.table(pheno,file="/Users/laurasaba/Documents/BxD/eQTL/Rqtl Files/pheno.dat",sep="\t",row.names=FALSE,col.names=FALSE, quote = FALSE)
write.table(pnames,file="/Users/laurasaba/Documents/BxD/eQTL/Rqtl Files/pnames.txt",sep="\t",row.names=FALSE,col.names=FALSE, quote = FALSE)
write.table(short.pheno,file="/Users/laurasaba/Documents/BxD/eQTL/Rqtl Files/phenoShort.dat",sep="\t",row.names=FALSE,col.names=FALSE, quote = FALSE)
write.table(short.pnames,file="/Users/laurasaba/Documents/BxD/eQTL/Rqtl Files/pnamesShort.txt",sep="\t",row.names=FALSE,col.names=FALSE, quote = FALSE)
...
for(i in 1:nphe){
	...
	filename = paste("Probe",probeID,"jpg",sep=".")

	jpeg(filename=filename,width=1500,height=480)
